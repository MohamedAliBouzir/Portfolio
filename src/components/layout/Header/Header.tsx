...
const Header: FC<IHeaderProps> = ({ children, className = undefined }) => {
  ...
  return (
    <header ref={refHeader} className={classNames(`w-full bg-gradient-to-tr from-primary to-transparent h-[var(${sizeHeader.height}px)] pt-[var(${sizeHeader.height}px)] pb-[var(${sizeHeader.height}px)]`, className)}>
