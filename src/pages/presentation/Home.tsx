          ...
          <div id="welcome page header container">
            ...
            <div id="description profile part">
              ...
              <div id="short description">
                Driven by a relentless pursuit of excellence, I'm a software
                engineer and ISSATSo graduate passionate about building
                exceptional web experiences. I'm not satisfied with "good
                enough"—I'm always pushing myself to achieve the best possible
                results. I bring a meticulous eye for detail to every project,
                ensuring high-quality code and optimal performance. I'm
                experienced in developing and maintaining websites, with a
                particular interest in optimizing and modernizing existing
                platforms. I thrive on challenges and embrace opportunities to
                elevate my skills and deliver impactful solutions.
              </div>
              <div id="media links">
